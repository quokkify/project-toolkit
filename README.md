...
jobs:
  python:
    uses: quokkify/project-toolkit/.github/workflows/python-ci.yml@v2.22.0
    with:
      python-version: "3.12"
      test-command: pytest
```
