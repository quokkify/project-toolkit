...
- `actions/allure-report/action.yml`
  - compatibility wrapper that forwards the CSP Allure 3 HTML/badge/PR-comment contract once to the immutable standalone `allure-report-action`
