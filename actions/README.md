...
- `actions/allure-report/action.yml`
  - compatibility wrapper that forwards the CSP Allure 3 HTML/badge/PR-comment contract once to standalone `allure-report-action` `v0.1.2` (`72fb74fff8b564040f12fd5d97b9867241e2c35d`)
