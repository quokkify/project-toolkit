...
- `actions/allure-report/action.yml`
  - compatibility wrapper that forwards the Allure 3 HTML/badge/PR-comment contract once to standalone `allure-report-action` `v0.2.0` (`07563998d9d52ef39b8375b360d02910006d4b3d`), including module-scoped environments
