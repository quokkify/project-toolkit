...
jobs:
  backend:
    uses: quokkify/project-toolkit/.github/workflows/python-ci.yml@v2.11.1
    with:
...
```console
copier copy https://github.com/quokkify/project-toolkit.git my-project --vcs-ref v2.11.1 --trust
cd my-project
copier update --trust
```
