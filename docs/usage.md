...
```console
copier copy https://github.com/quokkify/project-toolkit.git my-project --vcs-ref v2.21.6 --trust
cd my-project
copier update --trust
```
...
jobs:
  allure:
    uses: quokkify/project-toolkit/.github/workflows/allure-publisher.yml@v2.21.6
    permissions:
      actions: read
      contents: read
      pull-requests: write
